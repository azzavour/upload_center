...
<div class="card shadow-sm">
    <div class="card-header bg-white border-bottom">
        <h2 class="mb-0">
            <i class="fas fa-file-alt text-primary me-2"></i>Upload Details
        </h2>
        <p class="text-muted mb-0 mt-2">{{ $history->original_filename }}</p>
    </div>

    <div class="card-body">
        <a href="{{ route('history.index') }}" class="btn btn-outline-secondary mb-4">
        ...
        <div class="alert alert-success" role="alert">
            ...
            <p class="mb-0">The file has been processed successfully and inserted into the database.</p>
        </div>
        @elseif($history->status === 'failed')
        <div class="alert alert-danger" role="alert">
            <i class="fas fa-times-circle me-2"></i>
            <strong>Upload Failed!</strong>
            <p class="mb-0">An error occurred while processing the file.</p>
        </div>
        @endif
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <strong>Stored File Name</strong>
                        ...
                        <p class="mb-0">
                            @if($history->upload_mode === 'replace')
                                <span class="badge badge-soft-warning">
                                    <i class="fas fa-sync-alt me-1"></i>Replace (previous data removed)
                                </span>
                            @else
                                <span class="badge badge-soft-success">
                                    <i class="fas fa-plus-circle me-1"></i>Append (new data added)
                                </span>
                            @endif
                        </p>
                    </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <p class="mb-0">
                        <span class="badge badge-soft-primary">{{ $history->mappingConfiguration->mapping_index }}</span>
                    </p>
                </div>
                @endif
            </div>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-4">
                        <div class="p-3 border rounded">
                            ...
                            <small class="text-muted">Successful Rows</small>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="p-3 border rounded">
        ...
        <!-- ✅ Additional section: table of successfully imported data -->
        @if($history->status === 'completed' && $history->success_rows > 0)
        <div class="card mb-4">
            <div class="card-header bg-light d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    <i class="fas fa-table me-2"></i>Successfully Imported Data
                </h5>
                <div>
                    <span class="badge badge-soft-success me-2">{{ optional($importedData)->total() ?? 0 }} rows</span>
                    <button class="btn btn-sm btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#tableData" aria-expanded="false">
                        <i class="fas fa-eye me-1"></i>Show Table
                    </button>
                </div>
            </div>
            <div class="collapse" id="tableData">
                <div class="card-body">
                    ...
                    <div class="text-center py-3 text-muted">
                        ...
                        <p class="mb-0 mt-2">No data found</p>
                    </div>
                    @else
                    <div class="alert alert-info" role="alert">
                        <i class="fas fa-info-circle me-2"></i>
                        Displaying data from table: <code>{{ $targetTable }}</code> (20 records per page)
                    </div>
                            ...
                            <thead class="table-light">
                                <tr>
                                    ...
                                    @foreach($tableColumns as $column)
                                        ...
                                        @endif
                                    @endforeach
                                    <th width="150" class="text-center">Entry Time</th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <div class="mt-3 d-flex justify-content-between align-items-center">
                        <div class="text-muted small">
                            Showing {{ optional($importedData)->firstItem() ?? 0 }} - {{ optional($importedData)->lastItem() ?? 0 }} of {{ optional($importedData)->total() ?? 0 }} records
                        </div>
                        <div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (shouldExpand) {
        ...
        toggleBtn.innerHTML = '<i class="fas fa-eye-slash me-1"></i>Hide Table';
...
@endpush
        ...
        <div class="card border-danger mb-4">
            <div class="card-header bg-danger text-white">
                <h5 class="mb-0">
                    <i class="fas fa-exclamation-triangle me-2"></i>Error Details ({{ count($history->error_details) }} error)
                </h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
        ...
        <div class="card mt-4">
            <div class="card-header bg-light">
                <h5 class="mb-0">
                    <i class="fas fa-arrows-alt-h me-2"></i>Column Mapping Used
                </h5>
            </div>
            <div class="card-body">
                <div class="row">
