...
<div class="card shadow-sm">
    <div class="card-header bg-white border-bottom">
        <h2 class="mb-0">
            <i class="fas fa-plus-circle text-primary me-2"></i>Create New Department
        </h2>
    </div>
        ...
        <form action="{{ route('admin.departments.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" required class="form-control @error('name') is-invalid @enderror"
                    placeholder="Example: Finance Department" value="{{ old('name') }}">
                @error('name')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="code" class="form-control @error('code') is-invalid @enderror"
                    placeholder="Example: FIN (auto-generated if empty)" value="{{ old('code') }}">
                @error('code')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
